        ...
        <div className="glass-card p-8 md:p-10 !overflow-visible">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <a
                href="https://instagram.com/ikigaiperformance_"
                target="_blank"
                rel="noopener noreferrer"
                className={socialIconClass}
                aria-label="Instagram @ikigaiperformance_"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                href="mailto:karina.rodrigues@ikigaiperformance.com.br"
                className={socialIconClass}
                aria-label="E-mail: karina.rodrigues@ikigaiperformance.com.br"
              >
                <svg
                  className="w-5 h-5"
                  fill="none"
