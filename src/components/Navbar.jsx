  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="max-w-7xl mx-auto pl-8 pr-28 sm:pr-8 md:pr-32 flex items-center justify-between py-4">
            <a
            ...
            <div className="hidden md:flex items-center gap-8">
              {navLinks.map((link) => (
                <a
                  key={link.href}
                  href={link.href}
                  className="text-sm font-medium text-neutral-700 dark:text-primary-200/90 hover:text-primary-900 dark:hover:text-mist transition-colors"
                >
                  {link.label}
                </a>
              ))}
            ...
            <button
              ...
              className="md:hidden text-neutral-900 dark:text-primary-200 p-2"
            ...
            <div className="md:hidden glass-card rounded-none border-x-0 px-6 py-4 space-y-3">
              {navLinks.map((link) => (
                <a
                  ...
                  className="block text-sm font-medium text-neutral-700 dark:text-primary-200/90 hover:text-primary-900 dark:hover:text-mist py-2"
                >
                  {link.label}
                </a>
              ))}
